INSERT INTO "User"(userID, NAME, gender, birthday, phoneNumber, email, username, password)
VALUES
...
INSERT INTO Employee(employeeID, userID, startDate, endDate, position, salary)
VALUES
...
INSERT INTO Staff(userID, totalShifts, currentShift)
VALUES
    ('U002', 13, null),
    ('U003', 15, null),
    ('U004', 10, null);
